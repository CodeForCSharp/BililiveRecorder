...
namespace BililiveRecorder.UWP
{
    ...
    /// </summary>
    public partial class WorkDirectoryPage : Page, INotifyPropertyChanged
    {
        ...
        {
            var fileDialog = new FolderPicker()
            {
                SuggestedStartLocation = PickerLocationId.VideosLibrary
            };
            var result = await fileDialog.PickSingleFolderAsync();
            if (result != null)
            {
                WorkPath = result.Name;
            }
        }
